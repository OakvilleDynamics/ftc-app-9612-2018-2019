...
@Autonomous(name = "Time Auto Mode // UNTESTED", group = "Th0r Autonomous")
public class AutonomousTimerOpMode extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addData("ROBOT STATUS", "REVERSING...");
        telemetry.update();
        sleep(15000);
        // S2: Drive left 5 inches with 5 second timeout
        while (opModeIsActive() && (opModeRuntime.seconds() > 5.0)) {
